...
<body>
    <main class="flex flex-col h-screen items-center justify-center bg-gray-100">
        <h1 class="text-4xl font-bold text-center mt-10">Login Page</h1>
        ...
        <p class="mt-5">Don't have an account? <a href="/register" class="text-blue-600 hover:underline">Register here</a></p>
    </main>
</body>
</html>